...
HD_PWD='D:/verilog/ece3300l/Group H/ECE3300-Lab5-GroupH/lab_5/lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_updown_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_updown_top.tcl
