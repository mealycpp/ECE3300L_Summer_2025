...
HD_PWD='D:/verilog/ece3300l/Group H/ECE3300-Lab5-GroupH/lab_5/lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_updown_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_updown_top.tcl -notrace
