...
REM
REM Generated by Vivado on Mon Jul 21 18:44:25 -0700 2025
...
echo "xvlog --incr --relax -prj bcd_updown_top_tb_vlog.prj"
call xvlog  --incr --relax -prj bcd_updown_top_tb_vlog.prj -log xvlog.log
