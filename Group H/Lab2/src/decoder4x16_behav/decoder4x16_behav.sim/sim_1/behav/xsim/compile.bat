...
REM
REM Generated by Vivado on Mon Jun 23 11:31:04 -0700 2025
...
echo "xvlog --incr --relax -prj tb_decoder4x16_vlog.prj"
call xvlog  --incr --relax -prj tb_decoder4x16_vlog.prj -log xvlog.log
