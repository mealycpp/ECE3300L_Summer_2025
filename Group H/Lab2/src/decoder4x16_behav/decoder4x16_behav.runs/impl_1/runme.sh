...
HD_PWD='C:/Users/arvin/Desktop/ECE3300L_Summer_2025/Group H/Lab2/src/decoder4x16_behav/decoder4x16_behav.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder4x16_behav.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder4x16_behav.tcl -notrace
