...
HD_PWD='C:/Users/arvin/Desktop/ECE3300L_Summer_2025/Group H/Lab2/src/decoder4x16_behav/decoder4x16_behav.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder4x16_behav.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder4x16_behav.tcl
