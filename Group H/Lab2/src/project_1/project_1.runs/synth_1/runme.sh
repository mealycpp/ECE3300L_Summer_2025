...
HD_PWD='C:/Users/arvin/Desktop/ECE3300L_Summer_2025/Group H/Lab2/src/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mux_lab3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mux_lab3.tcl
