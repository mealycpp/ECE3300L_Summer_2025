...
REM
REM Generated by Vivado on Sun Jul 27 10:53:45 -0700 2025
...
echo "xvlog --incr --relax -prj seg7_scan_tb_vlog.prj"
call xvlog  --incr --relax -prj seg7_scan_tb_vlog.prj -log xvlog.log
