...
REM
REM Generated by Vivado on Thu Aug 14 20:23:06 -0700 2025
...
echo "xvlog --incr --relax -prj load_fsm_tb_vlog.prj"
call xvlog  --incr --relax -prj load_fsm_tb_vlog.prj -log xvlog.log
