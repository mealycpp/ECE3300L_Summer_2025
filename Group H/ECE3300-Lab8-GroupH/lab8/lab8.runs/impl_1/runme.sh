...
HD_PWD='D:/verilog/ece3300l/Group H/ECE3300-Lab8-GroupH/lab8/lab8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lab8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lab8.tcl -notrace
