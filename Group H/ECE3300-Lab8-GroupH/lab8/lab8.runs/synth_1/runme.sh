...
HD_PWD='D:/verilog/ece3300l/Group H/ECE3300-Lab8-GroupH/lab8/lab8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lab8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lab8.tcl
