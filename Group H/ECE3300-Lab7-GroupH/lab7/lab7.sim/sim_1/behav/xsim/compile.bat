...
REM
REM Generated by Vivado on Mon Aug 04 19:31:39 -0700 2025
...
echo "xvlog --incr --relax -prj top_lab7_vlog.prj"
call xvlog  --incr --relax -prj top_lab7_vlog.prj -log xvlog.log
