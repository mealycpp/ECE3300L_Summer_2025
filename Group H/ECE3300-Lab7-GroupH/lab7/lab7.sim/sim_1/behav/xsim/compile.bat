...
REM
REM Generated by Vivado on Tue Aug 05 19:07:02 -0700 2025
...
echo "xvlog --incr --relax -prj debounce_toggle_tb_vlog.prj"
call xvlog  --incr --relax -prj debounce_toggle_tb_vlog.prj -log xvlog.log
