## INPUT SWITCHES (SW0-SW4)
set_property PACKAGE_PIN J15 [get_ports {A[0]}]  ;# SW0 - LSB
...
set_property PACKAGE_PIN R15 [get_ports {A[3]}]  ;# SW3 - MSB
set_property IOSTANDARD LVCMOS33 [get_ports {A[3]}]

set_property PACKAGE_PIN R17 [get_ports {E}]     ;# SW4 - Enable
set_property IOSTANDARD LVCMOS33 [get_ports {E}]

## OUTPUT LEDS (LED0-LED15, left to right = Y[0] to Y[15])
